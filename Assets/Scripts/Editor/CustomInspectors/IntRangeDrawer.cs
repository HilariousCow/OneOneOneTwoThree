...
public class IntRangeDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        else
        {
            ...
            newMin = Mathf.Clamp(EditorGUI.IntField(minLabelRect, (int)newMin), range.MinLimit, newMax);
            ...
            newMax = Mathf.Clamp(EditorGUI.IntField(maxLabelRect, (int)newMax), newMin, range.MaxLimit);
